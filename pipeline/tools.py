...
from pipeline.tools_kakao import KAKAO_TOOL_SCHEMAS, KAKAO_TOOL_FUNCTIONS
...
TOOL_SCHEMAS.extend(KAKAO_TOOL_SCHEMAS)
...
TOOL_FUNCTIONS.update(KAKAO_TOOL_FUNCTIONS)
